  ...
  return (
    ...
    <div className="nodes">
      ...
      <div className={styles.myNodes}>
        ...
        <input type={"number"} placeHolder={"Enter nodes to purchase"} style={{width:"100%",marginTop:"4%"}} ref={inpAMT} min={0}></input>
        <button style={{width:"100%", marginTop:"4%"}} onClick={buyNode}>Buy</button>
        <button style={{width:"100%", marginTop:"4%"}} onClick={claim}>Claim</button>
      </div>
    </div>
    </React.Fragment>
  )
